...
Il pacchetto Laravel Modules (documentazione: [https://laravelmodules.com/project_docs/12/getting-started/introduction](https://laravelmodules.com/project_docs/12/getting-started/introduction)) consente di organizzare un'applicazione Laravel in moduli separati, ognuno con la propria struttura di directory simile a un'applicazione Laravel completa. Nel nostro progetto, il modulo `Activity` si trova in `/var/www/html/saluteora/laravel/Modules/Activity`.
