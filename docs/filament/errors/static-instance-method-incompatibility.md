...
- [Principio di sostituzione di Liskov](../../../UI/project_docs/filament/errors/static-instance-method-incompatibility.md)
- [Documentazione ufficiale Filament](https://filamentphp.com/project_docs/3.x/tables/columns)
